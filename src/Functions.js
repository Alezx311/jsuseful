...
// ! For fast results check
// const showAll = () => {
//   const ARR = [1, 2, 3, 4, 1, 12, 124, 1, 1, 1]
//   const OBJ = { some: 'asdasd', arr: ARR }
//   const STR = '123123123123123'

//   const message = `All:

// musicNote: ${Functions.musicNote()}
// musicScale: ${Functions.musicScale()}
// musicDuration: ${Functions.musicDuration()}
// musicInterval: ${Functions.musicInterval()}
// color: ${Functions.color()}
// colorName: ${Functions.colorName()}
// time: ${Functions.time()}
// timeDifference: ${Functions.timeDifference(Functions.time())}
// timestamp: ${Functions.timestamp()}
// datestamp: ${Functions.datestamp()}
// objClone: ${Functions.objClone(OBJ)}
// objKeys: ${Functions.objKeys(OBJ)}
// objValues: ${Functions.objValues(OBJ)}
// objEntries: ${Functions.objEntries(OBJ)}
// sleep: ${Functions.sleep(1000)}
// arrayIterator: ${Functions.arrayIterator(ARR)}
// findSubstrings: ${Functions.findSubstrings(STR, '123')}
// countSubstrings: ${Functions.countSubstrings(STR, '123')}
// objFreeze: ${Functions.objFreeze(OBJ)}
// bucketSort: ${Functions.bucketSort(ARR)}
// compare: ${Functions.compare(ARR, [1, 2, 3])}
// arrayQuickSort: ${Functions.arrayQuickSort(ARR)}
// arrayMax: ${Functions.arrayMax(ARR)}
// arrayMin: ${Functions.arrayMin(ARR)}
// arrayUnicals: ${Functions.arrayUnicals(ARR)}
// replaceByDictionary: ${Functions.replaceByDictionary({ source: STR, dictionary: { 1: 'w' } })}
// caesarCipher: ${Functions.caesarCipher(STR, 2)}
// compactObject: ${Functions.compactObject(OBJ)}
// countBy: ${Functions.countBy(ARR, v => !!v)}
// groupBy: ${Functions.groupBy(ARR, v => !!v)}
// flattenObject: ${Functions.flattenObject(OBJ)}
// mostFrequent: ${Functions.mostFrequent(ARR)}
// primes: ${Functions.primes(10)}
// toTitleCase: ${Functions.toTitleCase(STR)}
// arrayFrequencies: ${Functions.arrayFrequencies(ARR)}
// arrayCycleGenerator: ${Functions.arrayCycleGenerator(ARR)}
// isAnagram: ${Functions.isAnagram(STR, STR)}
// walkThrough: ${Functions.walkThrough(ARR)}
// arithmeticProgression: ${Functions.arithmeticProgression(10, 2)}
// averageBy: ${Functions.averageBy(ARR, v => !!v)}
// sumBy: ${Functions.sumBy(ARR, v => !!v)}
// cartesianProduct: ${Functions.cartesianProduct(ARR, [1, 2, 3])}
// bubbleSort: ${Functions.bubbleSort(ARR)}
// differenceBy: ${Functions.differenceBy(ARR, [1, 2, 3], v => !!v)}
// geometricProgression: ${Functions.geometricProgression(100, 10, 5)}
// palindrome: ${Functions.palindrome(STR)}
// powerset: ${Functions.powerset(ARR)}
// toRomanNumeral: ${Functions.toRomanNumeral(123)}
// toSafeInteger: ${Functions.toSafeInteger(-123)}
// isDateValid: ${Functions.isDateValid(Date.now())}
// deepFlatten: ${Functions.deepFlatten(ARR)}
// fibonacci: ${Functions.fibonacci(100)}
// filterNonUnique: ${Functions.filterNonUnique(ARR)}
// filterNonUniqueBy: ${Functions.filterNonUniqueBy(ARR, v => !!v)}
// indexOfAll: ${Functions.indexOfAll(ARR, 12)}
// isISOString: ${Functions.isISOString(Date.now())}
// delay: ${Functions.delay(() => console.log('delay'), 1000)}
// size: ${Functions.size(OBJ)}
