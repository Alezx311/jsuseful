...
export declare class Errors {
    static errBasic: (msg?: string) => Error;
    static errType: (msg?: string) => TypeError;
    static errEval: (msg?: string) => EvalError;
    static errRange: (msg?: string) => RangeError;
    static errSyntax: (msg?: string) => SyntaxError;
    static errReference: (msg?: string) => ReferenceError;
    static ERROR_BASIC: Error;
    static ERROR_TYPE: TypeError;
    static ERROR_EVAL: EvalError;
    static ERROR_RANGE: RangeError;
    static ERROR_SYNTAX: SyntaxError;
    static ERROR_REFERENCE: ReferenceError;
    static ERROR_TYPE_NOT_STRING: TypeError;
    static ERROR_TYPE_NOT_ARRAY: TypeError;
    static ERROR_VALUE: TypeError;
    static ERROR_VALUE_NOT_DEFINED: TypeError;
    static ERROR_VALUE_NOT_TRUTHY: TypeError;
    static ERROR_LENGTH: TypeError;
    static ERROR_LENGTH_SHORT: TypeError;
    static ERROR_LENGTH_LARGE: TypeError;
}
