...
exports.JsUseful = exports.Sources = exports.Errors = exports.Dates = exports.Objects = exports.Arrays = exports.Converters = exports.Validators = exports.JSUSEFUL = void 0;
...
Errors.errBasic = ERRORS.errBasic;
Errors.errType = ERRORS.errType;
Errors.errEval = ERRORS.errEval;
Errors.errRange = ERRORS.errRange;
Errors.errSyntax = ERRORS.errSyntax;
Errors.errReference = ERRORS.errReference;
Errors.ERROR_BASIC = ERRORS.ERROR_BASIC;
Errors.ERROR_TYPE = ERRORS.ERROR_TYPE;
Errors.ERROR_EVAL = ERRORS.ERROR_EVAL;
Errors.ERROR_RANGE = ERRORS.ERROR_RANGE;
Errors.ERROR_SYNTAX = ERRORS.ERROR_SYNTAX;
Errors.ERROR_REFERENCE = ERRORS.ERROR_REFERENCE;
Errors.ERROR_TYPE_NOT_STRING = ERRORS.ERROR_TYPE_NOT_STRING;
Errors.ERROR_TYPE_NOT_ARRAY = ERRORS.ERROR_TYPE_NOT_ARRAY;
Errors.ERROR_VALUE = ERRORS.ERROR_VALUE;
Errors.ERROR_VALUE_NOT_DEFINED = ERRORS.ERROR_VALUE_NOT_DEFINED;
Errors.ERROR_VALUE_NOT_TRUTHY = ERRORS.ERROR_VALUE_NOT_TRUTHY;
Errors.ERROR_LENGTH = ERRORS.ERROR_LENGTH;
Errors.ERROR_LENGTH_SHORT = ERRORS.ERROR_LENGTH_SHORT;
Errors.ERROR_LENGTH_LARGE = ERRORS.ERROR_LENGTH_LARGE;
class Sources {
    static getEntries(v) {
